...
- Before creating or modifying user-visible app or extension UI, read and follow `docs/design/neon-pilot-taste.md`; treat it as the source of truth for layout, density, control choice, surface treatment, copy, empty states, negative smells, and screenshot-backed taste review.
