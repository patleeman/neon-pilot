...
The built-in Browser is a Tauri-native webview embedded in a desktop workbench tab. It provides a shared visual context for the user and agent, where both see the same page.
...
| `browser_cdp`        | Execute arbitrary Chrome DevTools Protocol commands. Chromium CDP is not available in the Tauri WKWebView backend. |
