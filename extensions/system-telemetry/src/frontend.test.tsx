...
describe('TelemetryPage', () => {
  it('renders the native windowed diagnostics layout', () => {
    ...
    expect(container.querySelector('.wos-braid-chart .wos-chart-panel__header')).toBeTruthy();
    expect(container.querySelector('.wos-braid-line--errors')).toBeTruthy();
    expect(container.querySelector('.wos-heatmap-header')).toBeNull();
    expect(container.querySelector('.wos-braid-chart-header')).toBeNull();
