...
function QuietLoadingState({ label = "Loading", className }) {
  return /* @__PURE__ */ jsx("div", { className: cx("h-full min-h-0", className), role: "status", "aria-label": label, "aria-live": "polite" });
}
...
function SettingsRow({
  ...
  return /* @__PURE__ */ jsxs("div", { className: cx("ui-settings-row", disabled && "ui-settings-row-disabled", className), ...props, children: [
    /* @__PURE__ */ jsxs("div", { className: cx("ui-settings-row-copy", copyClassName), children: [
      /* @__PURE__ */ jsx("div", { className: "ui-settings-row-title", children: title }),
      description ? /* @__PURE__ */ jsx("div", { className: "ui-settings-row-description", children: description }) : null
    ] }),
    children ? /* @__PURE__ */ jsx("div", { className: cx("ui-settings-row-actions", actionsClassName), children }) : null
  ] });
}
function Switch({
  checked,
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ jsx("span", { className: "ui-switch-track", "aria-hidden": "true", children: /* @__PURE__ */ jsx("span", { className: "ui-switch-thumb" }) }),
        label ? /* @__PURE__ */ jsx("span", { className: "ui-switch-label", children: label }) : null
      ]
    }
  );
}
