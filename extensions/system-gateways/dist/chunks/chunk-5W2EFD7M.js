...
function LoadingState({ label, className }) {
  return /* @__PURE__ */ jsxs("div", { className: cx("ui-loading-state", className), role: "status", "aria-live": "polite", children: [
...
function CenteredState({ children, className, ...props }) {
  return /* @__PURE__ */ jsx("div", { className: cx("ui-centered-state", className), ...props, children });
}
function CenteredLoadingState({ label = "Loading...", className }) {
  return /* @__PURE__ */ jsx(CenteredState, { className, children: /* @__PURE__ */ jsx(LoadingState, { label }) });
}
function ErrorState({
  title,
  message,
...
function AppPageLayout({
  ...
  if (!aside) {
    return /* @__PURE__ */ jsx("div", { className: cx("ui-app-page-shell", shellClassName), children: /* @__PURE__ */ jsx("div", { className: cx("ui-app-page-main", contentClassName), children }) });
  }
  return /* @__PURE__ */ jsx("div", { className: cx("ui-app-page-shell", shellClassName), children: /* @__PURE__ */ jsxs("div", { className: cx(asideLayout === "centered" ? "ui-app-page-grid-centered" : "ui-app-page-grid", gridClassName), children: [
    /* @__PURE__ */ jsx("div", { className: cx("ui-app-page-main", asideLayout === "centered" && "ui-app-page-main-centered", contentClassName), children }),
    /* @__PURE__ */ jsx("div", { className: cx(asideLayout === "centered" ? "ui-app-page-aside-centered" : "ui-app-page-aside", asideClassName), children: aside })
  ] }) });
}
function AppPageIntro({
  eyebrow,
  title,
  summary,
  actions,
  ...
  return /* @__PURE__ */ jsxs("section", { className: cx("ui-app-page-intro", className), children: [
    /* @__PURE__ */ jsxs("div", { className: "min-w-0 space-y-2", children: [
      eyebrow ? /* @__PURE__ */ jsx("div", { className: "ui-app-page-eyebrow", children: eyebrow }) : null,
      /* @__PURE__ */ jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsx("h1", { className: cx("ui-app-page-title", titleClassName), children: title }),
        summary ? /* @__PURE__ */ jsx("div", { className: cx("ui-app-page-summary", summaryClassName), children: summary }) : null
      ] })
    ] }),
    actions ? /* @__PURE__ */ jsx("div", { className: "flex flex-wrap items-center justify-end gap-2", children: actions }) : null
  ] });
}
