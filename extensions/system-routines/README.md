...
- The **real app sidebar** lists lifecycle events and search/filter state through the `routines-sidebar` view.
...
- `Add routine ▾` opens a compact menu for **Instruction**, **Decision**, and **Stop**.
...
- Routines nav opens and lifecycle events appear in the real sidebar.
- Sidebar search filters events and selecting an event updates the timeline/inspector.
