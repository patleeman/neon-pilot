...
Creates the first-run welcome conversation for new Neon Pilot profiles.
...
The onboarding conversation explains the first useful steps: configure a provider in Settings, understand that Neon Pilot is extension-based, manage extensions from Settings → Extensions, then start a real task conversation.
