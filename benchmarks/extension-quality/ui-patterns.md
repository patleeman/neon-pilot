...
- Sidebar view: use the shared extension sidebar primitives when available. They should encode the native left-sidebar section style: uppercase accent section label, compact icon actions, no card/list panel chrome, and rows that scan like thread rows.
