...
export declare function mergeDeferredResumeStateDocuments(options: { documents: unknown[] }): DeferredResumeStateFile;
...
export declare function getDueScheduledSessionDeferredResumeEntries(
  state: DeferredResumeStateFile,
  sessionFile: string,
  at?: Date,
): DeferredResumeRecord[];
export declare function activateDeferredResume(
  state: DeferredResumeStateFile,
  input: {
    id: string;
    at?: Date;
...
export declare function activateDueDeferredResumes(
  state: DeferredResumeStateFile,
  input?: {
    at?: Date;
    sessionFile?: string;
...
export declare function scheduleDeferredResume(
  state: DeferredResumeStateFile,
...
export declare function createReadyDeferredResume(
  state: DeferredResumeStateFile,
  entry: Omit<DeferredResumeRecord, 'status' | 'readyAt' | 'kind' | 'delivery'> & {
    readyAt?: string;
    kind?: DeferredResumeKind;
...
export declare function retryDeferredResume(
  state: DeferredResumeStateFile,
  input: {
    id: string;
    dueAt: string;
