...
const WORKER_SAFE_LOCAL_API_ROUTES: Array<{
  ...
  { methods: new Set(['GET']), pattern: /^\/api\/extensions\/system-knowledge\/memory$/ },
  { methods: new Set(['GET']), pattern: /^\/api\/extensions\/system-knowledge\/vault\/tree$/ },
  { methods: new Set(['GET']), pattern: /^\/api\/extensions\/system-knowledge\/vault\/file$/ },
  { methods: new Set(['GET']), pattern: /^\/api\/extensions\/system-knowledge\/vault\/backlinks$/ },
  { methods: new Set(['GET']), pattern: /^\/api\/extensions\/system-knowledge\/vault\/search$/ },
  { methods: new Set(['GET']), pattern: /^\/api\/extensions\/system-knowledge\/vault\/note-search$/ },
  { methods: new Set(['GET']), pattern: /^\/api\/extensions\/system-knowledge\/asset$/ },
