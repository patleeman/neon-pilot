  ...
  return (
    <div className="ui-desktop-top-bar">
      <div className="ui-desktop-top-bar__leading">
        <div className="ui-desktop-top-bar__traffic-light-gap drag-region" aria-hidden="true" data-tauri-drag-region style={dragStyle} />
      ...
      <div className="ui-desktop-top-bar__center drag-region flex items-center justify-center gap-2" data-tauri-drag-region style={dragStyle}>
        <div
          ref={searchShellRef}
          className={cx(
