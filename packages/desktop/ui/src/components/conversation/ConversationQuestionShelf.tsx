  ...
  return (
    <div className="border-b border-border-subtle px-4 py-3.5">
      <div className="flex min-w-0 flex-wrap items-center gap-2">
        ...
        <Pill tone="warning" className="px-2.5 py-0.5 text-[12px]">
      ...
      <div className="mt-2 -mx-0.5" role={activeQuestion.style === 'check' ? 'group' : 'radiogroup'} aria-label={activeQuestion.label}>
