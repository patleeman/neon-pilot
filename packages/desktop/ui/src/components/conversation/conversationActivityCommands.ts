export const CONVERSATION_CONTINUE_DEFERRED_RESUMES_COMMAND_EVENT =
  'neon-pilot-conversation-continue-deferred-resumes-command';
export const CONVERSATION_TOGGLE_BACKGROUND_RUN_DETAILS_COMMAND_EVENT =
  'neon-pilot-conversation-toggle-background-run-details-command';
export const CONVERSATION_TOGGLE_DEFERRED_RESUME_DETAILS_COMMAND_EVENT =
