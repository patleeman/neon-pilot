  ...
  router.post('/api/extensions/clean-room-import', async (req, res) => {
    try {
      ...
      const prompt = [
        ...
        '',
        'RULES:',
        '- You ONLY have access to web_fetch, duckduckgo_search, and exa_search. DO NOT use any other tools.',
      ...
      const result = await startBackgroundRun({
        taskSlug:
          ...
          zipName
            ...
            .slice(0, 48),
        cwd,
        agent: { prompt, noSession: true, allowedTools: ['web_fetch', 'duckduckgo_search', 'exa_search'] },
