...
const requiredCanonicalStoryIds = [
  ...
  'windowed-os-desktop-shell--extensions-page',
  'windowed-os-desktop-shell--dark-extensions-page',
  'windowed-os-desktop-shell--extensions-install-dialog',
  'windowed-os-desktop-shell--dark-extensions-install-dialog',
