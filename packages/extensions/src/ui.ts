...
export declare const ContextRail: HostComponent;
export declare const ContextRailBody: HostComponent;
export declare const ContextRailHeader: HostComponent;
export declare const ContextRailSection: HostComponent;
...
export declare const DataTablePagination: HostComponent;
export declare const DataTableRow: HostComponent;
export declare const DataTableToolbar: HostComponent;
...
export declare function SegmentedControl<TValue extends string>(props: {
  value: TValue;
