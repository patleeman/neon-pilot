function hostResolved(): never {
  throw new Error('@neon-pilot/extensions/backend/mcp must be resolved by the Neon Pilot host runtime.');
}
...
export const callMcpToolDirect = (..._args: unknown[]): unknown => hostResolved();
export const connectMcpServerDirect = (..._args: unknown[]): unknown => hostResolved();
