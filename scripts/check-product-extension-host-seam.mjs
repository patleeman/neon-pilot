...
const forbiddenPatterns = [
  ...
  {
    pattern:
      /import\s+\{[^}]*\b(?:listExtensionAssemblyProviderRegistrations|listExtensionPromptAssemblyHookRegistrations|listExtensionPromptContextProviderRegistrations)\b[^}]*\}\s+from\s+['"][^'"]*\/extensions\/extensionRegistry\.js['"]/,
    message: 'product runtime prompt assembly code must read extension contributions through ExtensionHostClient',
  },
  {
    pattern:
      /import\(\s*['"][^'"]*\/extensions\/extensionRegistry\.js['"]\s*\)[\s\S]{0,300}\b(?:listExtensionAssemblyProviderRegistrations|listExtensionPromptAssemblyHookRegistrations|listExtensionPromptContextProviderRegistrations)\b/,
    message: 'product runtime prompt assembly code must read extension contributions through ExtensionHostClient',
  },
  {
    pattern:
  ...
  {
    pattern: /import\(\s*['"][^'"]*\/extensions\/extensionRegistry\.js['"]\s*\)[\s\S]{0,300}\blistExtensionToolRegistrations\b/,
    message: 'product runtime code must read extension tool registrations through ExtensionHostClient',
  },
  {
    pattern:
  ...
  {
    pattern: /import\(\s*['"][^'"]*\/extensions\/extensionRegistry\.js['"]\s*\)[\s\S]{0,300}\blistEnabledExtensionEntries\b/,
    message: 'product runtime code must read model discovery registrations through ExtensionHostClient',
  },
  {
  ...
  {
    pattern:
      /import\s+\{[^}]*\b(?:deleteExtensionState|listExtensionState|readExtensionState|writeExtensionState)\b[^}]*\}\s+from\s+['"][^'"]*\/extensions\/extensionStorage\.js['"]/,
    message: 'product runtime code must access extension state through ExtensionHostClient',
  },
  {
    pattern:
      /import\(\s*['"][^'"]*\/extensions\/extensionStorage\.js['"]\s*\)[\s\S]{0,300}\b(?:deleteExtensionState|listExtensionState|readExtensionState|writeExtensionState)\b/,
    message: 'product runtime code must access extension state through ExtensionHostClient',
  },
  {
    pattern:
