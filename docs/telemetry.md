...
Extension action telemetry uses the same app telemetry data. Extension Manager and other renderer-owned UI should read it through the native bridge/action surfaces, not direct extension HTTP routes.
