...
- [Knowledge](../extensions/system-knowledge/README.md) — installable knowledge, docs, skills, instruction files, and managed sync
...
- [Knowledge](../extensions/system-knowledge/README.md) — installable first-party extension
