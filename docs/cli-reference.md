...
Generated from `neon-pilot commands --json` with 89 commands.
...
- Source: core
- Usage: `neon-pilot commands [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
...
- Source: extension (system-conversation-tools)
- Usage: `neon-pilot conversations search <conversationId> [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
...
Examples:
- `neon-pilot conversations search conversation-example`
- `neon-pilot conversations search conversation-example --json`
...
- Source: extension (system-neon-pilot-admin-cli)
- Usage: `neon-pilot heartbeats stop [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Examples:
- `neon-pilot heartbeats stop`
- `neon-pilot heartbeats stop --json`
...
Cancel a subagent: subagents cancel <run-id>.

- Source: extension (system-runs)
- Usage: `neon-pilot subagents cancel <id> [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Examples:
- `neon-pilot subagents cancel example-id`
- `neon-pilot subagents cancel example-id --json`
...
Inspect a subagent run: subagents get <run-id>.

- Source: extension (system-runs)
- Usage: `neon-pilot subagents get <id> [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
...
Examples:
- `neon-pilot subagents get example-id`
- `neon-pilot subagents get example-id --json`

### subagents list

List durable subagent runs.

- Source: extension (system-runs)
- Usage: `neon-pilot subagents list [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
...
Rerun a subagent: subagents rerun <run-id>.

- Source: extension (system-runs)
- Usage: `neon-pilot subagents rerun <id> [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Examples:
- `neon-pilot subagents rerun example-id`
- `neon-pilot subagents rerun example-id --json`
