...
Generated from `neon-pilot commands --json` with 141 commands.
...
List installable app catalog entries.
...
Create an installed app package: extensions create <id> --name <name> [--template <template>]

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions create <appPackageId> [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Delete an installed app package by id. System apps cannot be deleted.
...
Disable an installed app package.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions disable <appPackageId> [--json]`
- Mode: write
- Requires app: no
- Idempotent: yes
- Destructive: no
...
Enable an installed app package.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions enable <appPackageId> [--json]`
- Mode: write
- Requires app: no
- Idempotent: yes
- Destructive: no
...
Install an app package from the catalog: extensions install <id>

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions install <appPackageId> [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Install an app package bundle from URL: extensions install-url <url> [--expected-id <id>]
...
List installed Neon Pilot app packages.
...
Reload an app package by id, or refresh app package state.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions reload [appPackageId] [--json]`
- Mode: write
- Requires app: no
- Idempotent: yes
- Destructive: no
...
Run smoke checks for an installed app package.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions smoke <appPackageId> [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Snapshot an installed app package by id.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions snapshot <appPackageId> [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Update a catalog-installed app package: extensions update <id>

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions update <appPackageId> [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
Validate an installed app package by id.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions validate <appPackageId> [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
