...
- Usage: `neon-pilot events delay <type> (--due-at <iso> | --delay-ms <ms>) --source <source> [--payload-json <json>] [--json]`
- Mode: background
- Requires app: no
- Idempotent: no
- Destructive: no
...
- Source: extension (system-automations)
- Usage: `neon-pilot events emit <type> --source <source> [--payload-json <json>] [--json]`
- Mode: background
- Requires app: no
- Idempotent: no
- Destructive: no
...
- Source: extension (system-automations)
- Usage: `neon-pilot events list [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
...
- Source: extension (system-automations)
- Usage: `neon-pilot events subscriptions save <id> --name <name> --pattern <pattern> --action-json <json> [--json]`
- Mode: write
- Requires app: no
- Idempotent: yes
- Destructive: no
