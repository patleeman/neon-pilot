...
Generated from `neon-pilot commands --json` with 100 commands.
...
Schedule an event to be emitted later: events delay <type> --due-at <iso> --source <source>.

- Source: extension (system-automations)
- Usage: `neon-pilot events delay <type> (--due-at <iso> | --delay-ms <ms>) --source <source> [--payload-json <json>] [--metadata-json <json>] [--json]`
- Mode: background
- Requires app: no
- Idempotent: no
- Destructive: no
...
### events delayed cancel

Cancel a pending delayed event bus event.

- Source: extension (system-automations)
- Usage: `neon-pilot events delayed cancel <delayed-event-id> [--json]`
- Mode: destructive
- Requires app: no
- Idempotent: no
- Destructive: yes
...
- `neon-pilot events delayed cancel delay_123 --json`

### events emit

Emit an event into the event bus: events emit <type> --source <source> [--payload-json <json>].

- Source: extension (system-automations)
- Usage: `neon-pilot events emit <type> --source <source> [--payload-json <json>] [--metadata-json <json>] [--json]`
- Mode: background
- Requires app: no
- Idempotent: no
- Destructive: no
...
- Source: extension (system-automations)
- Usage: `neon-pilot events list [--type <type>] [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
...
- `neon-pilot events list`
- `neon-pilot events list --json`

### events process-due

Process due delayed event bus events now.

- Source: extension (system-automations)
- Usage: `neon-pilot events process-due [--limit <count>] [--json]`
- Mode: background
- Requires app: no
- Idempotent: no
- Destructive: no
...
Prune recorded event bus events by retention policy.

- Source: extension (system-automations)
- Usage: `neon-pilot events prune [--older-than <iso>] [--keep-latest <count>] [--json]`
- Mode: destructive
- Requires app: no
- Idempotent: yes
- Destructive: yes
...
Replay an event by re-emitting it against current subscriptions.

- Source: extension (system-automations)
- Usage: `neon-pilot events replay <event-id> [--json]`
- Mode: background
- Requires app: no
- Idempotent: no
- Destructive: no
...
Delete an event bus subscription.

- Source: extension (system-automations)
- Usage: `neon-pilot events subscriptions delete <id> [--json]`
- Mode: destructive
- Requires app: no
- Idempotent: no
- Destructive: yes
...
- `neon-pilot events subscriptions delete sub-tweets --json`
...
- Source: extension (system-automations)
- Usage: `neon-pilot events subscriptions list [--json]`
- Mode: read
- Requires app: no
- Idempotent: yes
- Destructive: no
...
### events subscriptions save

Create or update an event subscription: events subscriptions save <id> --name <name> --pattern <pattern> --action-json <json>.

- Source: extension (system-automations)
- Usage: `neon-pilot events subscriptions save <id> --name <name> --pattern <pattern> --action-json <json> [--enabled | --disabled] [--json]`
- Mode: write
- Requires app: no
- Idempotent: yes
- Destructive: no
...
- `neon-pilot events subscriptions save sub-tweets --name "Tweet Worker" --pattern tweet.* --action-json '{"type":"start_agent","prompt":"Summarize this tweet"}' --json`
