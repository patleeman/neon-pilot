...
Generated from `neon-pilot commands --json` with 153 commands.
...
Build an installed user extension with Neon Pilot's packaged authoring runtime.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions build <extensionId> [--dry-run] [--json]`
- Mode: write
- Requires app: no
- Idempotent: yes
- Destructive: no
...
- `neon-pilot extensions build local-models --dry-run --json`
...
- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions create <extensionId> --name <name> [--description <text>] [--template <template>] [--json]`
- Mode: write
- Requires app: no
- Idempotent: no
- Destructive: no
...
- `neon-pilot extensions create reading-list --name "Reading List" --template page`
- `neon-pilot extensions create local-models --name "Local Models" --template application --json`
...
Invoke a callable action on an installed extension.

- Source: extension (system-extension-manager)
- Usage: `neon-pilot extensions invoke <extensionId> <actionId> [--input-json <json>] [--dry-run] [--json]`
- Mode: write
- Requires app: yes
- Idempotent: no
- Destructive: no
...
- `neon-pilot extensions invoke reading-list listArticles --input-json '{}' --json`
...
- Usage: `neon-pilot routines delete <routine-id> [--json]`
- Mode: write
- Requires app: yes
- Idempotent: yes
- Destructive: yes
...
- `neon-pilot routines delete routine_123 --json`
...
- Source: extension (system-routines)
- Usage: `neon-pilot routines list [--json]`
- Mode: read
- Requires app: yes
- Idempotent: yes
- Destructive: no
...
- `neon-pilot routines move routine_123 --position after --target-routine-id routine_456 --json`

### routines reorder

Set routine order from a JSON array of routine IDs.

- Source: extension (system-routines)
- Usage: `neon-pilot routines reorder --routine-ids <json-array> [--json]`
- Mode: write
- Requires app: yes
- Idempotent: yes
- Destructive: no
...
- `neon-pilot routines reorder --routine-ids '["routine_1","routine_2"]' --json`

### routines run-hook

Run routines for a hook.

- Source: extension (system-routines)
- Usage: `neon-pilot routines run-hook <hook-id> [--position before|after] [--context <json>] [--json]`
- Mode: write
- Requires app: yes
- Idempotent: no
- Destructive: no
...
- `neon-pilot routines run-hook agent.after_turn --context '{"conversationId":"conv_123"}' --json`

### routines save

Create or update a routine from JSON.

- Source: extension (system-routines)
- Usage: `neon-pilot routines save --routine <json> [--json]`
- Mode: write
- Requires app: yes
- Idempotent: yes
- Destructive: no
...
- `neon-pilot routines save --routine '{"name":"Review","hookId":"agent.after_turn","instruction":"Summarize","enabled":true}' --json`

### routines skills

List skills available to routines.

- Source: extension (system-routines)
- Usage: `neon-pilot routines skills [--json]`
- Mode: read
- Requires app: yes
- Idempotent: yes
- Destructive: no
...
- `neon-pilot routines skills --json`
