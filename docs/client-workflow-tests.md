...
| Settings | Settings nav opens provider and desktop panels, edits constrained controls, persists through reload, and shows validation errors | `ui/src/pages/SettingsPage.desktopConnections.test.tsx` covers desktop panel persistence and duplicate shortcut validation; provider tests cover model/provider editor workflows. Add route-level settings nav coverage across sections. |
