...
1. Conversation window needs a full windowed styling and workbench affordance pass.
   ...
   - 2026-07-04 progress: composer warning notices now use a neutral windowed surface with a warning stripe instead of a heavy warning fill, keeping "No workspace attached" readable in dark compact chat. Verified with windowed OS tests/builds, Storybook build, and Chrome-rendered 360px dark inherited-chat QA with no horizontal overflow.
